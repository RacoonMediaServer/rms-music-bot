module github.com/RacoonMediaServer/rms-music-bot

go 1.20

require (
	github.com/RacoonMediaServer/rms-media-discovery v1.5.4
	...
	github.com/anacrolix/torrent/fs v0.0.0-20230823215932-b836d2ad53ee
